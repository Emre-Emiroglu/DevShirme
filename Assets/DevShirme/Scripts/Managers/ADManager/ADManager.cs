...
{
    public class ADManager : Manager
    {
        #region Fields
        public static Action OnRewardedADCallBack;
        public UnityEvent OnRewardedADBegan;
        public UnityEvent OnRewardedADEnded;
        [Header("AD Manager Fields")]
        [SerializeField] private ADData data;
        ...
        {
#if UNITY_ANDROID
            string id = data.GetID(Enums.ADType.Banner, true);
#elif UNITY_IPHONE
  ...
  string id = "unused";
        ...
        {
#if UNITY_ANDROID
            string id = data.GetID(Enums.ADType.Interstital, true);
#elif UNITY_IPHONE
  ...
  string id = "unused";
        ...
        {
#if UNITY_ANDROID
            string id = data.GetID(Enums.ADType.Rewarded, true);
#elif UNITY_IPHONE
